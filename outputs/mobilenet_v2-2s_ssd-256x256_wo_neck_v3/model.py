...
log_level = 'INFO'
work_dir = '/home/dobryaev/projects/mmdetection/outputs/mobilenet_v2-2s_ssd-256x256_wo_neck_v3'
load_from = None
resume_from = '/home/dobryaev/projects/mmdetection/outputs/mobilenet_v2-2s_ssd-256x256_wo_neck/latest.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 1)
